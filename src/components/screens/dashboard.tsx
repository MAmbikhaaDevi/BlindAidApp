...
export const DashboardScreen: React.FC<ScreenProps> = ({ navigate }) => {
  ...
  useEffect(() => {
    const timeoutId = setTimeout(() => {
      speak("Welcome to BLIND AID. You are on the dashboard. You can say 'Detect objects', or 'Settings'.");
    }, 500);
  ...
  return (
    <div className="p-4 space-y-4 fade-in">
      ...
      <p className="text-center text-xs text-muted-foreground pt-4">Created By NBHS Students , Pune,2026.</p>
    </div>
  );
};
